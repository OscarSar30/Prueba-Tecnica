package ec.com.pruebagizlo.es.usuarioexterno.controller.contract;
...
public interface IUsuarioExternoController {
    ...
    @Operation(summary = "Consulta Usuario por Tipo de Usuario", description = "Consulta Usuario por Tipo de Usuario", tags={ "UsuarioExternoES v1.0" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = UsuarioExternoType.class)))),
    ...
    @Operation(summary = "Crear nuevo usuario externo", description = "Crear nuevo usuario externo", tags={ "UsuarioExternoES v1.0" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<?> crearUsuarioExterno(@Parameter(in = ParameterIn.DEFAULT, description = "Crear nuevo usuario externo", schema=@Schema()) @Valid @RequestBody UsuarioExternoType body);
